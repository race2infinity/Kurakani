...
public class newSession extends AppCompatActivity {
    ...
    public ArrayList<String> finallist2 = new ArrayList<String>();
        ...
        String resultURL = "http://192.168.0.8:3020/depdata";
        ...
        // This is called everytime someone clicks on the department
        ...
        protected void onPostExecute(String result)
        {
            try {
                ...
                for(int i=0;i<arr.length();i++) {
                    ...
                    String resultURL = "http://192.168.0.8:3020/depdata/"+id;
